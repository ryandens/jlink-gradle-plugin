...
plugins {
  application
  id("com.ryandens.jlink-application") version "0.5.1"
}
...
plugins {
  ...
  id("com.ryandens.jlink-jib") version "0.5.1"
}
...
plugins {
  application
  id("com.ryandens.jlink-jib") version "0.5.1"
  id("com.ryandens.temurin-binaries-repository") version "0.5.1"
}
...
plugins {
  java
  id("com.ryandens.jlink-jre") version "0.5.1"
}
